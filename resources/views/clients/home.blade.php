                    ...
                    @foreach($products as $product)
                        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <div class="pt-6">
                                ...
                                <a href="{{route("view", $product)}}" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{$product->name}}</a>
                                ...
                                <div class="mt-4 flex items-center justify-between gap-4">
                                    ...
                                    <button type="button" data-popover-target="{{$product->id}}number" class="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                        ...
                        <div data-popover id="{{$product->id}}number" role="tooltip" class="absolute z-10 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-32 dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600">
                            <div class="p-0.5">
