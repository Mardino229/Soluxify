                    ...
                    <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                        <div class="space-y-6">
                            @if($cart==[])
                                ...
                                <h1 class="text-center mb-4">Cart is empty</h1>
                            @endif
                            @foreach($cart as $item)
                                <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    <a href="{{route('view', $item['product'])}}" class="shrink-0 md:order-1">
                                    ...
                                    <div class="flex items-center justify-between md:order-3 md:justify-end">
                                        ...
                                        <div class="text-end md:order-4 md:w-32">
                                            <p class="text-base font-bold text-gray-900 dark:text-white">XOF {{$item['total']}}</p>
                                        </div>
                                    </div>
                            ...
                            <div class="space-y-4">
                                <div class="space-y-2">
                                    <dl class="flex items-center justify-between gap-4">
                                        ...
                                        <dd class="text-base font-medium text-gray-900 dark:text-white">XOF {{$total}}</dd>
                                    </dl>

                                    <dl class="flex items-center justify-between gap-4">
                                        <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Savings</dt>
                                        <dd class="text-base font-medium text-green-600">-XOF 0.00</dd>
                                    </dl>

                                    <dl class="flex items-center justify-between gap-4">
                                        <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Store Pickup and Delivery</dt>
                                        <dd class="text-base font-medium text-gray-900 dark:text-white">XOF 5</dd>
                                    </dl>
                                </div>

                                <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                                    <dt class="text-base font-bold text-gray-900 dark:text-white">Total</dt>
                                    <dd class="text-base font-bold text-gray-900 dark:text-white">XOF {{$total+5}}</dd>
                                </dl>
                            </div>
{{--                            <button--}}
{{--                                    @if(!$total)--}}
...
{{--        position="right"--}}
{{--        theme="#0095ff"--}}
{{--        sandbox="{{env("SANDBOX")? "true" : 'false'}}"--}}
{{--        key="{{ $total ? env("KKIAPAY_PUBLIC_KEY") : ''}}"--}}
{{--        src="https://cdn.kkiapay.me/k.js"></script>--}}
